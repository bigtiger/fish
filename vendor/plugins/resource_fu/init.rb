...
require 'proto_cool/resource_fu/default_template_path'
...
# add default_template_path to ActionController::Base
ActionController::Base.send :include, ProtoCool::ResourceFu::DefaultTemplatePath
